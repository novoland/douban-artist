...
//        self.__indicatorX.indicator.style[self.__transformProperty] = 'translateX(' + x + 'px) scaleX(' + widthScale + ')';
    }
...
//        self.__indicatorY.indicator.style[self.__transformProperty] = 'translateY(' + y + 'px) scaleY(' + heightScale + ')';
    }
  },
  ...
  resize: function() {
    ...
    this.setDimensions(
    	...
    	Math.max(this.__content.scrollHeight, this.__content.offsetHeight) - this.__refreshHeight);
  },
  /*
  ---------------------------------------------------------------------------
    PUBLIC API
...
//      return parseFloat(this.el.style.webkitTransform.replace('translate3d(', '').split(',')[0]);
        return parseFloat(this.el.style.webkitTransform.replace('translateX(', '').split(',')[0]);
    },
...
//          this.handle.style.webkitTransform = 'translate3d(' + openPixel + 'px,0,0)';
            this.handle.style.webkitTransform = 'translateX(' + openPixel + 'px)';
        }
      }
    },
